...
//$input = '"byc\x9dyxuafof\\\xa6uf\\axfozomj\\olh\x6a"';
/*
$input = <<<'EOD'
"\x71sxl\"gj\"sds\"ulcruguz\\t\\ssvjcwhi"
EOD;
...
foreach (preg_split('/\n/', $input) as $line) {
	...
	$line = preg_replace_callback('/(\\\x[0-9a-f][0-9a-f])/', function($matches) {
		return 'a'; //hex2str($matches[1]);
	}, $line);
/*
...
*/
	...
	$mymemory = strlen($line);

	echo "--$line--\n";
	echo "total: $mytotal\n";
	echo "memory: $mymemory\n";
